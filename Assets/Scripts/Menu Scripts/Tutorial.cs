...
public class Tutorial : MonoBehaviour
{
    ...
    public BasePlayer spillerref2;
    
    [SerializeField]
    //Mangler Reference til penge
    //private Penge penge;
    ...
    void Update()
    {
        ...
        if(spillerref.heldObj.tag.Contains("Product") || spillerref2.heldObj.tag.Contains("Product"))
        {
        ...
        if(RoundManager.Instance.money > 0)
        {
            Pil_Order.SetActive(false);
